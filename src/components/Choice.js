    ...
    <React.Fragment>
        ...
        <div className="lg:-mt-64 z-32">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path fill="#0099ff" fill-opacity="1" d="M0,64L80,80C160,96,320,128,480,170.7C640,213,800,267,960,261.3C1120,256,1280,192,1360,160L1440,128L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
            <h1>hello</h1>
            </svg>
        </div>
    </React.Fragment>
