...
class HistoryPage extends React.Component {
  ...
  getQuestion = async () => {
    axios({
      method: 'GET',
      url: 'https://backend.rielcoin.com/history-question',
      body: JSON.stringify({
  ...
  endGame = () => {
    ...
    setTimeout(() => {
      this.props.history.push('/history-result', playerStats);
    }, 2000);
  };
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <form
          id="backgrond"
          className=" -mt-20 container shadow-xl rounded-lg pb-8 mb-4 mx-auto h-auto"
        >
          <div className="-mt-2 fill-current text-xl pr-8 pl-8 pb-8 flex justify-between">
