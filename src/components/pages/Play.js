...
//           <button
//             type="button"
//             className="mt-10 bg-red-600 hover:bg-red-800 rounded-md w-32 shadow-lg text-white font-bold py-2 px-4 rounded justify-center text-center"
//             onClick={quitAlert}
//           >
//             quit
//           </button>
        ...
        <form className=" bg-gray-200 container shadow-xl rounded px-8 pt-6 pb-8 mb-4 mx-auto mt-12 h-full">
          ...
          {/* <div className="question container text-xl sm:block">
            <button
              type="button"
              onClick={this.handleOptionClick}
              className=" option xs:w-2/4 inline-blocklg:w-2/4 lg:my-5 xl:w-2/4  lg:py-3 lg:px-4 bg-teal-400 hover:bg-teal-600 text-white font-bold rounded-full"
            >
              {currentQuestion.optionA}
            </button>
            <button
              type="button"
              onClick={this.handleOptionClick}
              className=" option xs:w-2/4 sm:w-full lg:w-2/4 lg:my-5 xl:w-2/4 lg:py-3 lg:px-4 bg-teal-400 hover:bg-teal-600 text-white font-bold rounded-full"
            >
              {currentQuestion.optionB}
            </button>
