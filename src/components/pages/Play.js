...
//   randomQuestion = () =>{
//     const randomNumber = Math.floor(Math.random() * this.state.questions.length);
//     return this.state.questions[randomNumber]; 
// } 
       ...
       <React.Fragment>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
          ...
          <div className=" fill-current text-xl pr-8 pl-8 pb-8 flex justify-between">
            ...
            <div onClick={this.handleHints} className="transition duration-200 ease-in-out transform hover:-translate-y-1 text-blue-600 lg:mr-48">
           ...
           <div className="mx-auto justify-center px-12 mt-6">
            <div className="sm:flex">
              <button
                ...
                className="option transition duration-500 ease-in-out transform hover:-translate-y-1 blok mt-3 option bg-teal-400 ml-10 hover:bg-teal-800 sm:ml-0 w-3/4 sm:w-2/4 lg:w-2/4 xs:w-2/4 text-white font-bold py-3 px-4 rounded-full "
              >
              ...
              <button
                type="button"
                onClick={this.handleOptionClick}
                className="option transition duration-500 ease-in-out transform hover:-translate-y-1 sm:ml-6 mt-3 block option bg-teal-400 hover:bg-teal-800 ml-10 sm:ml-0 w-3/4 sm:w-2/4  text-white font-bold py-3 px-4 rounded-full"
              >
            ...
            <div className="sm:flex mt-3">
              <button
                type="button"
                onClick={this.handleOptionClick}
                className="option transition duration-500 ease-in-out transform hover:-translate-y-1 block mt-3 option bg-teal-400 hover:bg-teal-800 ml-10 sm:ml-0 w-3/4 sm:w-2/4 text-white font-bold py-3 px-4 rounded-full"
              >
              ...
              <button
                type="button"
                onClick={this.handleOptionClick}
                className="option transition duration-500 ease-in-out transform hover:-translate-y-1 mt-3 sm:ml-6 block option bg-teal-400 hover:bg-teal-800 ml-10 sm:ml-0 w-3/4 sm:w-2/4 text-white font-bold py-3 px-4 rounded-full"
              >
          ...
          <div className="pl-12">
            <button id="previous-button" type="button" onClick={this.handleButtonClick} className="bg-yellow-600 hover:bg-yellow-800 rounded mt-10 mx-2 w-32 shadow-lg text-white font-bold py-2 px-4 rounded justify-center text-center">
                Prev
            </button>
            ...
            <button type="button" onClick={quitAlert} className="bg-red-600 hover:bg-red-800 rounded mt-10 mx-2 w-32 shadow-lg text-white font-bold py-2 px-4 rounded justify-center text-center">
              quit
            </button>
          </div>
        </form>
