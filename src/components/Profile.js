...
const Profile = () => {
  ...
  const walletSubmit = (e) => {
    e.preventDefault();
    axios
      .post('https://testnet-api.selendra.com/apis/v1/get-wallet', {
  ...
  useEffect(() => {
    axios({
      ...
      .then((res) => {
        setwallet(res.data);
        console.log('wallet Get', res.data.wallet);
        axios({
          method: 'GET',
          url:
            'https://horizon-testnet.stellar.org/accounts/' + res.data.wallet,
          headers: {
          ...
          .then((res) => {
            setBalance(res.data);
            console.log('Get Ballen', res.data);

            console.log('Get Ballen', res.data.balances[0].balance);
          })
          .catch((error) => {
            console.log(error);
          });
  ...
  const submitName = async (e) => {
    ...
    // await fetch('https://backend.rielcoin.com/uploadProfile', {
    //   method: 'POST',
    //   headers: {
    //     'Content-Type': 'multipart/form-data',
    //     token: accessTokenObj,
                  ...
                  <label htmlFor="upload-button">
                    {image.preview ? (
                      <img
                        src={image.preview}
                        style={{ marginTop: '-27px' }}
                        className=" md:-mt-20  sm:mx-auto h-24 w-24 -mt-16 md:h-32 md:w-32 rounded-full cursor-pointer   "
                      />
                    ) : (
                      <>
            ...
            <div className="bg-gray-200  rounded mb-4">
              <div className="py-10">
                <div className="sm:block md:flex">
                  <div className="px-16">
                    <img
                      className="border-solid border-2 border-gray-300 h-24 w-24  md:h-32 md:w-32 rounded-full   "
                      src={profile ? profile.user_profile : ''}
                    />
                  </div>
                  <div className="sm:px-24 px-12">
                    <span className="ml-2 sm:mx-auto font-bold text-2xl text-blue-600">
                      {profile ? profile.user_name : ''}
                    </span>
                    <div className=" flex  sm:justify-center  rounded-md ">
                      <svg
                        className="fill-current text-gray-700 svg-icon h-8 w-8 text-justify"
                        viewBox="0 0 20 20"
                      >
              ...
              <div className="px-8 -mb-1">
                <input
                  ...
                  value="Edit Profile"
                  onClick={popUp}
                  className="edit-button  focus:outline-none float-right md:-mt-12 bg-no-repeat border-blue-500 border-2 px-3 py-1 w-40 bg-blue-400 rounded-full hover:bg-blue-200 hover:text-gray-600 text-white cursor-pointer"
                />
              </div>
            </div>
              ...
              <div className="transition duration-500 ease-in-out transform hover:-translate-y-1 max-w-sm bg-white hover:shadow-lg cursor-pointer rounded overflow-hidden">
                ...
                <div className=" px-2 mb-2">
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="  hover:-translate-y-1 max-w-sm bg-white hover:shadow-lg cursor-pointer rounded overflow-hidden">
                        <img className="w-full" src="/img/Calculating.png" />
                        <div className=" py-4">
                          <div className="font-bold text-xl mb-2 text-center">
                            <h1>Calculating</h1>
                          </div>
                      ...
                      <div className="  hover:-translate-y-1 max-w-sm bg-white hover:shadow-lg cursor-pointer rounded overflow-hidden">
                        <img className="w-full" src="/img/World History.png" />
                        <div className=" py-4">
                          <div className="font-bold text-xl mb-2 text-center">
                            <h1>Histroy</h1>
                          </div>
                      ...
                      <div className="  hover:-translate-y-1 max-w-sm bg-white hover:shadow-lg cursor-pointer rounded overflow-hidden">
                        <img className="w-full" src="/img/Science.png" />
                        <div className=" py-4">
                          <div className="font-bold text-xl mb-2 text-center">
                            <h1>Science</h1>
                          </div>
